...
<script>
import RandomUtil from "C:/Users/Shx/backend-golang/xhs_modified_front/xhs_vue2/src/utils/randomUtil";
import Store from "C:/Users/Shx/backend-golang/xhs_modified_front/xhs_vue2/src/utils/store";
export default {
  name: 'HomeView',
  data() {
    return {
